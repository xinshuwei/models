...
class BaseTest(golden.BaseTest):
  ...
  def test_bottleneck_v1_width_8_channels_4_batch_size_32_with_proj(self):
    """Test of a single ResNet block."""
    self._resnet_block_ops(test=True, batch_size=32, bottleneck=True,
                           projection=True, version=1, width=8, channels=4)

  def test_bottleneck_v2_width_8_channels_4_batch_size_32_with_proj(self):
    """Test of a single ResNet block."""
    self._resnet_block_ops(test=True, batch_size=32, bottleneck=True,
                           projection=True, version=2, width=8, channels=4)

  def test_bottleneck_v1_width_8_channels_4_batch_size_32(self):
    """Test of a single ResNet block."""
    self._resnet_block_ops(test=True, batch_size=32, bottleneck=True,
                           projection=False, version=1, width=8, channels=4)

  def test_bottleneck_v2_width_8_channels_4_batch_size_32(self):
    """Test of a single ResNet block."""
    self._resnet_block_ops(test=True, batch_size=32, bottleneck=True,
                           projection=False, version=2, width=8, channels=4)

  def test_building_v1_width_8_channels_4_batch_size_32_with_proj(self):
    """Test of a single ResNet block."""
    self._resnet_block_ops(test=True, batch_size=32, bottleneck=False,
                           projection=True, version=1, width=8, channels=4)

  def test_building_v2_width_8_channels_4_batch_size_32_with_proj(self):
    """Test of a single ResNet block."""
    self._resnet_block_ops(test=True, batch_size=32, bottleneck=False,
                           projection=True, version=2, width=8, channels=4)

  def test_building_v1_width_8_channels_4_batch_size_32(self):
    """Test of a single ResNet block."""
    self._resnet_block_ops(test=True, batch_size=32, bottleneck=False,
                           projection=False, version=1, width=8, channels=4)

  def test_building_v2_width_8_channels_4_batch_size_32(self):
    """Test of a single ResNet block."""
    self._resnet_block_ops(test=True, batch_size=32, bottleneck=False,
                           projection=False, version=2, width=8, channels=4)
